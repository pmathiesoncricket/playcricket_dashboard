...
from tab_data_loader import data_loader_tab
...
# of which one is visible -- this is what was driving load times up with
# several tabs' worth of DB queries firing at once. With a selectbox, the
# other pages' queries simply never run until you pick them.
