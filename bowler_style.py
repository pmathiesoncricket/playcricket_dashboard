...
from db import conn, get_matches, get_bowling_deliveries, get_player_style
...
def bowler_style_tab():
    ...
    with highlight_col:
        ...
        highlights_df = st.session_state.get("_bowler_highlights_cache")
        from db import get_highlights
